        ...
        <section class="info-leccion">
            ...
            <div class="ejemplo">
                <p style="font-size: 3em; text-align: center;">
                    Un grupo de <?php echo htmlspecialchars($dividendo)?> turistas 🧑‍🤝‍🧑 debe viajar en autobuses. Si
                    cada autobus tiene capacidad de <?php echo htmlspecialchars($divisor)?> personas.</p>
                <p style="font-size: 3em; text-align: center;">
                    ¿cuántos autobuses se llenarán completamente y cuántos turistas irán en el último autobús (residuo)?
                </p><label>
                    ...
                    <a href="Division3.php" style="text-decoration: none; margin-top: 50px; display: block;">Dificultad
                        Dificil
                    </a>
            </div>
        </section>
