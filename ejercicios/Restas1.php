...
<body>
    <div class=" main-content">
        <header class="header">
            <h1>Problema de Resta Nivel <?php echo htmlspecialchars($nivel_dificultad); ?> ➖ <?php
                    echo $mensaje;
                ?></h1>
        </header>
        ...
        <section class="info-leccion">
            ...
            <div class="ejemplo">
                <p style="font-size: 3em; text-align: center;">
                    Si tienes <?php echo htmlspecialchars($minuendo)?> globos y se rebentaron
                    <?php echo htmlspecialchars($sustraendo)?> </p>
                <p style="font-size: 3em; text-align: center;">
                    Cuántos globos te quedan?
                </p><label>
                    ...
                    <a href="Restas2.php" style="text-decoration: none; margin-top: 50px; display: block;">Dificultad
                        Media
                    </a>
            </div>
        </section>
