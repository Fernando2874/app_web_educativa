        ...
        <section class="info-leccion">
            ...
            <div class="ejemplo">
                <p style="font-size: 3em; text-align: center;">
                    Una compañia de libros 📚 imprimio un total de <?php echo htmlspecialchars($dividendo)?> ejemplares
                    de una novel. Si los ejemplares se empacan en cajas que
                    contienen <?php echo htmlspecialchars($divisor)?> libros cada uno.</p>
                <p style="font-size: 3em; text-align: center;">
                    ¿cuántas cajas completas se utilizaron para empacar todos los libros?
                </p><label>
                    ...
                    <a href="Divisiones.html" class="btn" style="margin-top: 50px;">Volver a
                        la
                        leccion
                    </a>
            </div>
